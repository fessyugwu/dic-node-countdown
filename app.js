  ...
  const svgImage = `
    ...
    <g transform="matrix(5.55556,0,0,5.55556,0,0)">
        ...
        <g transform="matrix(1.20548,0,0,1.20548,-28.9937,-57.5784)">
            <text x="124.181px" y="278.219px" style="font-family:'MicrogrammaD-BoldExte', 'Microgramma D', 'MicrogrammaEF Extend', 'MicrogrammaEF';font-weight:700;font-size:30.358px;fill:white;">${daysDiff}</text>
        </g>
    </g>
    <defs>
      ${imageBase64}
